...
module.exports = {
  ...
  themeCSSImport: (req, res, next) => {
    ...
    res.render = (view, locals, cb) => {
      ...
      locals.themeLayoutCSSImport = locals.pageName && fs.existsSync(themeCSSDir + '/layout/' + locals.layout + '.min.css');
      locals.themePageCSSImport = locals.layout && fs.existsSync(themeCSSDir + '/pages/' + locals.pageName + '.min.css');

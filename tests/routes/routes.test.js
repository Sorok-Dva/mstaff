  ...
  describe('/GET Invalid Page (404)', () => {
    ...
    it('should show 404 error', (done) => {
      chai.request(app)
        .get('/invalid/page')
        .end((err, res) =>{
          res.body.should.contain('Page Introuvable');
          done
        })
    });
  });
  describe('/GET Landing Page', () => {
    ...
    it('should render landing layout template', (done) => {
      chai.request(app)
        .get('/')
        .end((err, res) =>{
          res.body.should.contain('Mstaff vous accompagne dans la gestion de vos candidatures.');
          done()
        })
    });
  });
  ...
  describe('/GET login', () => {
    ...
    it('should render login form', (done) => {
      chai.request(app)
        .get('/login')
        .end((err, res) =>{
          res.body.should.contain('<form action="/login" method="post">');
          done()
        })
    });
  });
